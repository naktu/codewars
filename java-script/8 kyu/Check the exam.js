...
// ["a","a", "b", "d"]. The second one is "answers" array and contains student's
// answers.
//
...
// incorrect answer, and +0 for each blank answer(empty string).
//
...
function checkExam(array1, array2) {
    let result;
    result = 0;
    for (let step = 0; step < array1.length; step++){
        if (array1[step] === array2[step]){
            result += 4;
        } else if (array2[step] !== "") {
            result--;
        }
